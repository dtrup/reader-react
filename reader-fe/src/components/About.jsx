...
const About = () => {
    return (
        ...
        <Box sx={{padding:7}}>
            ...
            <p className="aboutText">If you are not into foreign languages or do not need to learn one, probably you won't be late for your next meeting absorbed by this website. The intended audience is made of either individuals who would fancy a useful distraction while learning a foreign language or polyglots who enjoy finding expressive subtleties in the originals or their translations. </p>
            ...
            <p className="aboutText">The original texts are accompanied by one or more translations. <i> The Portrait of Dorian Gray</i> , for instance, is available in English, French and German. The Bible, while not yet ready in Old Greek or Hebrew, is waiting for the reader in more than 10 languages, which include, in addition to the above, Dutch, Indonesian or Romanian. </p>
            ...
            <p className="aboutText">A final word about the source of the texts. They are all public domain and already largely available. What is different is the way the reader sees it. </p>
        </Box>
    )
}
